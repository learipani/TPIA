...
public class EstadoAspiradora extends SearchBasedAgentState {
    ...
    public void initState() {
        //Éste método también debe tomar los valores del escenario particulat
        
        Habitacion h1 = new Habitacion("h1");
        Habitacion h2 = new Habitacion("h2");
        
        //habitacionesSucias arranca vacío
    ...
    public boolean equals(Object obj) {
    	...
    	//Cuándo dos estados son iguales lo definimos nosotros
    	//En este caso definimos que dos estado son iguales cuando estamos en la misma
    	//habitación y la lista de habitaciones limpias es la misma (y la lista de visitadas!!)
