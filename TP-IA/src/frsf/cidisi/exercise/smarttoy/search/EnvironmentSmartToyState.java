...
public class EnvironmentSmartToyState extends EnvironmentState {
    ...
    public void initState() {
    	...
    	this.ubicacionSmartPhone.setFirst(this.getPlano().get(14)); //Habitacion .get(HABITACION)
    	this.ubicacionSmartPhone.setSecond(new int[]{11,6}); //Posicion dentro de la habitación {FILA, COLUMNA})
